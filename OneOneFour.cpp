...
int main(void)
{
    ...
    ofstream grid("gridOneOneFour.txt"),loSEs("listOfSEsOneOneFour.txt");

    add_edge(0,1,string("a"),GM);
    add_edge(1,0,string("b"),GM);
    add_edge(1,1,string("c"),GM);
    add_edge(1,1,string("d"),GM);
    add_edge(1,1,string("e"),GM);
    add_edge(1,1,string("f"),GM);
    ...
    add_edge(1,1,string("y"),HM);
    add_edge(1,1,string("z"),HM);
