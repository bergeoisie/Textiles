...
int main(void)
{
    int i,j=1,k,l;
    bool found=false;
    Graph GM(3),HM(3),GH,HG,PM,MP,M,N;
    ...
    ofstream grid("gridTbTA.txt"),loSEs("listOfSEsTbTA.txt");
