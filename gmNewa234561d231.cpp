...
int main(void)
{
    ...
    add_edge(0, 2, PQ_Homoms(string("b"),Q_Homom(string("a"),string("F"))),G);
    ...
    ofstream gviz("gviza234561d231.dat");
	...
	ofstream os("conjugaciesa234561d231.txt",ios_base::app);
    for(i=-1; i>-4;i--)
    {
		for(j=1; j<5; j++)
		{
