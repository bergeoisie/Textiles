...
typedef adjacency_list<vecS,vecS, bidirectionalS, PQ_VHomoms, PQ_Homoms> GammaGraph;
...
int main(void)
{
    ...
    add_edge(1, 0, PQ_Homoms(string("b"),Q_Homom(string("a"),string("D"))),G);
    ...
    ofstream gviz("gviza2143d231.dat");
